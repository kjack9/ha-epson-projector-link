...
# Dynamic Ranges
#
# Should keep in sync with epson_projector_link/services.yaml select_dynamic_range options
DYNAMIC_RANGE_CODE_MAP = {
    "00": "Auto",
    "01": "SDR",
    "21": "HDR10",
    "30": "HLG"
}
DYNAMIC_RANGE_CODE_INVERTED_MAP = invert_map(DYNAMIC_RANGE_CODE_MAP)
